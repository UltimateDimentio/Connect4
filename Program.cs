namespace Connect4
{
    ...
    class Controller : GameBoard
    {
        ...
        //Will take the InitializeBoard method from GameBoard and use it as a reset board
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                while (winner == null)
                {
                    ...
                    {
                        //Won't print due to Console.Clear() previously declared
                ...
                //Display board one last time with the result
                Console.Clear();
                controller.DisplayBoard();
                ...
                Console.WriteLine($"Number of turns: {player.Turns}");

                //Check if the player desires to play again
                Console.WriteLine($"\nDo you want to play again (Y or N)");
                playAgain = Console.ReadLine();
                //Invalid input check
                while (playAgain == null || playAgain != "Y" && playAgain != "N")
                {
                    //Visual error, it will keep printing the line without deleting the previous line
                    Console.WriteLine("Invalid input, try again.");
                    playAgain = Console.ReadLine();
                }
                //If player desires to play again, reset winner value to null and player Turns to 0
                if (playAgain == "Y")
                {
                    winner = null;
                    player.Turns = 0;
            ...
            //Game finished, finish the program
            Console.Clear();
